    ...
    <div id="ask-panel" className="px-4 py-4 border-b border-[var(--card-border)] bg-[var(--card-bg)]/85">
      ...
      <div className="flex flex-col lg:flex-row gap-2">
        ...
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm font-medium border border-[var(--accent)] bg-[var(--accent-soft)] text-[var(--accent-strong)] hover:bg-[var(--accent-soft-strong)] disabled:opacity-50 disabled:cursor-not-allowed"
        >
